document.addEventListener('DOMContentLoaded', () => {
  ...
  engine.onCalculate = (v) => {
    ...
    const result = {
      primary: `${engine.formatNumber(bmr, 0)} kcal`,
      primaryLabel: 'Basal Metabolic Rate',
      items: [
        { label: 'TDEE', value: `${engine.formatNumber(tdee, 0)} kcal/day` },
        { label: 'Activity Level', value: v.activity || 'sedentary' },
        { label: 'Weight Loss (-500)', value: `${engine.formatNumber(tdee - 500, 0)} kcal` }
      ]
    };
